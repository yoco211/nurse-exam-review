const pastQuestions = [
  {
    ...
    category: "必修",
    difficulty: "標準",
    question: "成人の安静時の正常な脈拍数に最も近いのはどれか。",
    options: ["20〜30回/分", "60〜100回/分", "120〜160回/分", "180〜220回/分"],
    answer: 1,
    explanation: "成人の安静時脈拍は一般に60〜100回/分である。年齢、活動量、薬剤、発熱などによって変動する。",
    note: "確認ポイント：安静時、成人、正常な脈拍数。"
  },
  {
    id: "past-115-2",
    source: "過去問対策",
    ...
    category: "人体構造",
    difficulty: "標準",
    question: "心臓から全身へ血液を送り出す主な血管はどれか。",
    options: ["大動脈", "肺静脈", "上大静脈", "門脈"],
    answer: 0,
    explanation: "左心室から拍出された血液は大動脈を通って全身へ送られる。",
    note: "体循環と肺循環の流れを図で確認する。"
  },
  {
    id: "past-115-3",
    source: "過去問対策",
    ...
    category: "疾病看護",
    difficulty: "応用",
    question: "慢性閉塞性肺疾患の患者にみられやすい症状はどれか。",
    options: ["労作時呼吸困難", "多尿", "徐脈", "黄疸"],
    answer: 0,
    explanation: "COPDでは気流制限により労作時呼吸困難、咳嗽、喀痰などがみられやすい。",
    note: "禁煙支援、呼吸リハビリ、増悪予防も重要。"
  },
  {
    id: "past-114-1",
    source: "過去問対策",
    ...
    category: "人体構造",
    difficulty: "基礎",
    question: "血液中で酸素運搬を主に担う成分はどれか。",
    options: ["血小板", "白血球", "赤血球", "血漿"],
    answer: 2,
    explanation: "赤血球に含まれるヘモグロビンが酸素運搬を担う。血小板は止血、白血球は免疫防御に関与する。",
    note: "赤血球とヘモグロビンの働きをセットで覚える。"
  },
  {
    id: "past-114-2",
    source: "過去問対策",
    ...
    category: "必修",
    difficulty: "基礎",
    question: "医療安全におけるインシデント報告の目的で適切なのはどれか。",
    options: ["再発防止に役立てる", "個人を罰する", "記録を残さない", "患者に説明しない"],
    answer: 0,
    explanation: "インシデント報告は原因分析と再発防止に活用するための仕組みである。",
    note: "医療安全では個人責任だけでなくシステム改善を考える。"
  },
  {
    id: "past-114-3",
    source: "過去問対策",
    ...
    category: "在宅看護",
    difficulty: "標準",
    question: "訪問看護で初回訪問時に優先して確認する内容はどれか。",
    options: ["療養環境と本人の希望", "近隣住民の趣味", "家具の購入価格", "テレビ番組の好み"],
    answer: 0,
    explanation: "初回訪問では療養環境、生活状況、本人・家族の希望、緊急時対応などを確認する。",
    note: "在宅では生活の場を理解する視点が必要。"
  },
  {
    id: "past-113-1",
    source: "過去問対策",
    ...
    category: "疾病看護",
    difficulty: "標準",
    question: "糖尿病患者への生活指導で優先度が高い内容はどれか。",
    options: ["水分摂取を完全に制限する", "足部の観察を習慣化する", "運動はすべて避ける", "食事回数を1日1回にする"],
    answer: 1,
    explanation: "糖尿病では末梢神経障害や足病変が起こりやすいため、足部観察、清潔、適切な靴の選択が重要である。",
    note: "糖尿病看護ではフットケアが頻出。"
  },
  {
    id: "past-113-2",
    source: "過去問対策",
    ...
    category: "社会保障",
    difficulty: "標準",
    question: "成年後見制度の説明で適切なのはどれか。",
    options: ["判断能力が不十分な人を支援する", "医療者だけが利用できる", "未成年者だけを対象とする", "本人の意思確認を不要にする"],
    answer: 0,
    explanation: "成年後見制度は判断能力が不十分な人の権利や生活を支援する制度である。",
    note: "権利擁護と意思決定支援を関連づける。"
  },
  {
    id: "past-113-3",
    source: "過去問対策",
    ...
    category: "必修",
    difficulty: "基礎",
    question: "バイタルサインに含まれる項目はどれか。",
    options: ["体温", "視力", "身長", "血液型"],
    answer: 0,
    explanation: "バイタルサインには体温、脈拍、呼吸、血圧、意識状態などが含まれる。",
    note: "正常値と測定時の注意点を合わせて覚える。"
  },
  {
    id: "past-112-1",
    source: "過去問対策",
    ...
    options: ["国", "都道府県", "市町村および特別区", "医療機関"],
    answer: 2,
    explanation: "介護保険制度の保険者は市町村および特別区である。都道府県は支援や調整を担う。",
    note: "保険者、被保険者、給付の関係を整理する。"
  },
  {
    id: "past-112-2",
    source: "過去問対策",
    ...
    category: "疾病看護",
    difficulty: "標準",
    question: "褥瘡予防の看護で適切なのはどれか。",
    options: ["定期的に体位変換を行う", "皮膚を湿ったままにする", "栄養状態を確認しない", "圧迫部位を放置する"],
    answer: 0,
    explanation: "褥瘡予防では体位変換、圧迫除去、皮膚観察、栄養管理が重要である。",
    note: "リスク評価にはブレーデンスケールなどが用いられる。"
  },
  {
    id: "past-112-3",
    source: "過去問対策",
    ...
    category: "人体構造",
    difficulty: "標準",
    question: "インスリンを分泌する主な臓器はどれか。",
    options: ["膵臓", "肝臓", "脾臓", "腎臓"],
    answer: 0,
    explanation: "インスリンは膵臓のランゲルハンス島β細胞から分泌され、血糖を下げる。",
    note: "インスリンとグルカゴンの作用を対比する。"
  },
  {
    id: "past-111-1",
    source: "過去問対策",
    ...
    category: "在宅看護",
    difficulty: "応用",
    question: "在宅酸素療法を受ける利用者への説明で適切なのはどれか。",
    options: ["火気を近づけない", "流量は自由に増減してよい", "外出は必ず禁止する", "加湿器の水は交換しなくてよい"],
    answer: 0,
    explanation: "酸素は燃焼を助けるため、火気を近づけてはならない。酸素流量は医師の指示に従って使用する。",
    note: "在宅酸素療法では火気厳禁が基本。"
  },
  {
    id: "past-111-2",
    source: "過去問対策",
    ...
    category: "社会保障",
    difficulty: "基礎",
    question: "日本の国民皆保険制度の特徴で適切なのはどれか。",
    options: ["原則として全ての国民が公的医療保険に加入する", "医療保険は任意加入のみである", "高齢者は制度の対象外である", "保険料は医療機関が全額負担する"],
    answer: 0,
    explanation: "日本では国民皆保険により、原則としてすべての国民が公的医療保険に加入する。",
    note: "医療保険、介護保険、年金を分けて整理する。"
  },
  {
    id: "past-111-3",
    source: "過去問対策",
    ...
    category: "在宅看護",
    difficulty: "標準",
    question: "在宅療養者の災害対策で適切なのはどれか。",
    options: ["非常時の連絡先と必要物品を確認する", "医療機器の電源対策は不要である", "避難先を決めない", "家族への説明を避ける"],
    answer: 0,
    explanation: "在宅療養では災害時の連絡先、避難方法、薬剤、医療機器の電源確保を確認する。",
    note: "酸素療法や人工呼吸器使用者では停電時の対応が重要。"
  }
];
...
const aiTemplates = [
  ...
  },
  {
    ...
    options: [
      ["尿を生成し体液を調整する", "胆汁を貯蔵する", "血糖を直接分解する", "食物を機械的に粉砕する"],
      ["ガス交換", "胆汁生成", "尿濃縮", "血球産生"]
    ],
    answers: [0, 0],
  ...
  },
  {
    ...
    options: [
      ["体重増加と浮腫", "爪の長さのみ", "髪色の変化", "嗜好品の銘柄"],
      ["意識レベルと麻痺の変化", "趣味の変化", "食器の好み", "病室の方角"]
    ],
    answers: [0, 0],
  ...
  },
  {
    ...
    options: [
      ["住み慣れた地域で生活を支える", "病院だけで生活支援を完結する", "家族支援を制度から除外する", "予防活動を行わない"],
      ["公的医療保険により医療費負担を支える", "全額を常に自己負担する", "保険証は介護施設だけで使う", "予防接種は制度と無関係である"]
    ],
    answers: [0, 0],
  ...
  },
  {
    ...
    options: [
      ["選択肢を説明し意思を確認する", "看護師がすべて決定する", "本人の希望を聞かない", "家族の都合のみを優先する"],
      ["介護負担と休息状況を確認する", "家族の訴えを聞かない", "介護方法を説明しない", "相談先を知らせない"]
    ],
    answers: [0, 0],
...
function getFilteredPastQuestions() {
  return pastQuestions.filter((item) => {
...
function createAiQuestion() {
  const pool = state.category === "all"
    ? aiTemplates
    : aiTemplates.filter((item) => item.category === state.category);
...
function clampPastPosition() {
  ...
  state.pastPosition = Math.min(state.pastPosition, list.length - 1);
}
...
function renderQuestion(question) {
  ...
  els.sourceBadge.textContent = question.exam ? `${question.source}｜${question.exam}（${question.year}年）` : question.source;
...
function renderStats() {
  const allQuestions = [...pastQuestions, ...state.aiHistory];
